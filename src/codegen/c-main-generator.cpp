...
void CiMainGenerator::Gen_MainSource()
{
  ...
  fwriter.Append("#endif // %s", fdesc->gen.usemon_def.c_str());
  fwriter.Append("");
  fwriter.Append("// This macro guard is for the case when you need to enable");
  ...
  fwriter.Append("// proper getframehash implementation. For providing one you");
  fwriter.Append("// need define macro before this line - in dbccodeconf.h");
  fwriter.Append("");
  ...
  fwriter.Append("// binutil is not accessed. For providing one you need define");
  fwriter.Append("// macro before this line - in dbccodeconf.h");
  fwriter.Append("");
  fwriter.Append("#ifndef AlertReceptionTimeout");
  fwriter.Append("#define AlertReceptionTimeout(msgid,lastcyc)");
  fwriter.Append("#endif");
  fwriter.Append("");
  fwriter.Append("// This macro guard is for the case when you need to enable");
  fwriter.Append("// using diag monitors but Transmit function in binutil is");
  fwriter.Append("// not accessed. For providing one you need define macro");
  fwriter.Append("// before this line - in dbccodeconf.h");
  fwriter.Append("");
  fwriter.Append("#ifndef SendCanMessage");
  fwriter.Append("#define SendCanMessage(msgid,ide,d,len) (1u)");
  fwriter.Append("#endif");
  fwriter.Append("");
  fwriter.Append();
